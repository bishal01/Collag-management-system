# Generated by Django 3.1.1 on 2020-11-26 04:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], default='Female', max_length=25)),
        ...
        migrations.AddField(
            model_name='class',
            name='courses',
            field=models.ManyToManyField(to='polls.Course'),
        ),
        migrations.AddField(
            model_name='class',
            name='dept',
